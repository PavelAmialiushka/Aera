...
#else
    hprintf(LogFile, _T("No registers in win64 :(\r\n"));
#endif
}
                                ...
                                LPCTSTR lpszMessage)
{
    ...
    TCHAR szCurrentDir[MAX_PATH*2];
    TCHAR szModuleName[MAX_PATH*2];
    ZeroMemory(szModuleName, sizeof(szModuleName));

    if (SHGetSpecialFolderPath(NULL, &szModuleName[0], CSIDL_APPDATA, true)==0)
    {
        lstrcpy(szModuleName, _T("Unknown"));
    }

    strcat(szModuleName, "\\AeraTools\\");
    TCHAR *pszFilePart = strchr(szModuleName, 0);

    strcpy(szCurrentDir, szModuleName);
    ...
    else
    {
        ...
        GetModuleFileName(0, szModuleName, _countof(szModuleName));
        ...
        if (CreateProcess(
                    ...
                    szCurrentDir, // current directory name
