...
#define _STLP_DISTANCE_TYPE(_It, _Tp)     (typename std::iterator_traits< _Tp >::difference_type*)0
#define _STLP_VALUE_TYPE(_It, _Tp)        (typename std::iterator_traits< _Tp >::value_type*)0

#else

#define _STLP_DISTANCE_TYPE(_It, _Tp) std::_Dist_type(_It)
#define _STLP_VALUE_TYPE(_It, _Tp)    std::_Val_type(_It)
	...
	{
		while (__last - __first > 1)
			utils::pop_heap(__first, __last--, __comp);
	}
